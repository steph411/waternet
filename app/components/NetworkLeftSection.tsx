...
const NetworkLeftSection: React.FC<Props> = ({className, userId, userInfos, profileInfos, createGroup=true}) => {
  ...
  return (
    <section className={"self-start px-4 space-y-2 overflow-hidden overflow-y-scroll rounded-t-lg w-60 " + className} >
        <ProfileResume
          userId={userId}
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="overflow-y-scroll divide-cold-gray-200 max-h-80">
            {

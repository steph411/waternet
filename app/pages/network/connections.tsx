...
const NetworkPage: FCWithLayout<Props> = () => {
  ...
  return (
    <>
      ...
      <section className="flex flex-col pr-3 space-y-2 overflow-hidden overflow-y-scroll" style={{ maxHeight: "calc(100vh - 128px)"}} >
      ...
      {/* right section */}
      <section className="flex flex-col pr-3 space-y-4 overflow-y-scroll " style={{ maxHeight: "calc(100vh - 128px)"}}>
        {[1].map((el,id) => (
          <AdSection key={id}/>
        ))} 
      </section>
